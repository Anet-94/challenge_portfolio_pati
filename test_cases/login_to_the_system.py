...
class TestLoginPage(unittest.TestCase):
    ...
    def test_TC1_log_in_title_of_page(self):
        self.user_login.title_of_page()

    def test_TC2_log_in_title_in_header(self):
        self.user_login.compare_the_login_form_title()

    def test_TC3_log_in_to_the_system(self):
    ...
    def test_TC4_negative_log_in_to_the_system(self):
